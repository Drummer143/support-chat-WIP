        ...
        <div className={styles.wrapper}>
            ...
            {currButtonsSet && (
                <div className={styles.buttons}>
                    <button className={styles.button} onClick={buttons[currButtonsSet[0]].onClick}>{buttons[currButtonsSet[0]].text}</button>
                    <button className={styles.button} onClick={buttons[currButtonsSet[1]].onClick}>{buttons[currButtonsSet[1]].text}</button>
                </div>
            )}
        </div>
    );
